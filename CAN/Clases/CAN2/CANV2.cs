...
/// 22/AGO/24
/// </summary>
public class CANV2 : IGPS, IBDContext, IBDContextCAN2

{
    ...
    vmdEntities IBDContext.VMD_BD => ((IBDContext)objProtocolo).VMD_BD;
    ...
    /// <summary>
    /// Se encarga de verificar los eventos abiertos para ser cerrados
    /// </summary>
    ...
    public void RecibirCANFirma(string _Operador)
    {
    ...
    /// <summary>
    /// se encarga de actualizar los procesos internos
    /// danchita45
    /// 19Sep2024
    /// </summary>
